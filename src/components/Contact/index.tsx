      ...
      <section className="overflow-hidden py-16 xl:py-20">
        <div className="section-container">
          <div className="flex flex-col xl:flex-row gap-7.5">
            <div className="w-full border border-cream-dark bg-white xl:max-w-[370px]">
              <div className="border-b border-cream-dark py-5 px-4 sm:px-7.5">
                <p className="text-custom-xs font-semibold uppercase tracking-[0.14em] text-dark">
                  Contact Information
                </p>
              </div>
            ...
            <div className="w-full border border-cream-dark bg-white p-4 sm:p-7.5 xl:p-10 xl:max-w-[770px]">
              <form>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      id="firstName"
                      placeholder="Jhon"
                      className="w-full border border-cream-dark bg-white py-2.5 px-4 text-custom-sm text-dark outline-none duration-200 placeholder:text-dark-4 focus:border-dark"
                    />
                  </div>
