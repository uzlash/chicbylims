  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row flex-wrap gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 ${
        ...
        >
          ...
          {/* <!-- header top right --> */}
            <div className="flex w-full lg:w-auto items-center justify-between gap-5 lg:gap-7.5">
