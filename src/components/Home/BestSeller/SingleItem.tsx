      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-dark">{symbol}{formatPrice(displayDiscounted, currency)}</span>
        ...
        <div className="flex justify-center items-center">
          {item.imgs?.previews?.[0] ? (
            <Image src={item.imgs.previews[0]} alt={item.title || "Product Image"} width={280} height={280} className="object-contain" />
          ) : (
            <div className="flex items-center justify-center w-[280px] h-[280px] bg-gray-2 text-gray-500">
              No Image
            </div>
          )}
        </div>
