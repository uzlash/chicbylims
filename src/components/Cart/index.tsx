      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-16 xl:py-20">
          <div className="section-container">
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="heading-serif text-display-3">Your Cart</h2>
              <button onClick={() => dispatch(removeAllItemsFromCart())} className="text-custom-sm text-blue hover:underline">
                Clear shopping cart
              </button>
            </div>
        ...
        <>
          <div className="text-center mt-8">
            ...
            <p className="pb-6 text-body">Your cart is empty.</p>

            <Link href="/shop" className="btn-primary mx-auto w-96 max-w-full">
              Continue Shopping
            </Link>
          </div>
        </>
